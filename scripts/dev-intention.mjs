...
const children=[spawn(process.execPath,['node_modules/tsx/dist/cli.mjs','services/intention-prototype/server.ts'],{stdio:'inherit'}),spawn(process.execPath,['node_modules/vite/bin/vite.js','apps/web','--config','apps/web/vite.intention-generation.config.ts'],{stdio:'inherit'})];
let stopping=false;
