...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/courtyard-2-7/expanded.ndjson.gz`. SHA256 `09b65c4d605648a25d0ad0ad6cee0085dfab678bf0da16a7e0bc154884fd818e`; 122,967 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway courtyard-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/courtyard-2-7/legacy.ndjson.gz`. SHA256 `3dca5d27fefe1b7a8d981527d1059951c4fb7fdf4d6e4755419d85ea593e5667`; 147,293 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway courtyard-2-7 --mode legacy --stage prescreen --limit 20
```
