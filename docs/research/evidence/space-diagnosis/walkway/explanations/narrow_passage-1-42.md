...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/narrow_passage-1-42/expanded.ndjson.gz`. SHA256 `52f91ee0b358982e69548e7a0d287ae920df3bdf23f88839b8dd3b5a8d07392a`; 52,473 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway narrow_passage-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/narrow_passage-1-42/legacy.ndjson.gz`. SHA256 `756eeeca4b13ca866af449db43bbc030b77fc224fc9d99f5113ed1344119f120`; 35,697 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway narrow_passage-1-42 --mode legacy --stage prescreen --limit 20
```
