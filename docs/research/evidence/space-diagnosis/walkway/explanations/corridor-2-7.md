...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/corridor-2-7/expanded.ndjson.gz`. SHA256 `0b3b66d32d0400eb4e013a44c4c659167cf55716b8c25558287a1720b18ec537`; 1,071,604 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway corridor-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/corridor-2-7/legacy.ndjson.gz`. SHA256 `976d45911e18e846f3391d836ab6d2b89ad12a1fee0c83be9529726a0915b1b5`; 702,592 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway corridor-2-7 --mode legacy --stage prescreen --limit 20
```
