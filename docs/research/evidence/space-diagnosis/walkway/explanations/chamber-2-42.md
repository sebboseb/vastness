...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/chamber-2-42/expanded.ndjson.gz`. SHA256 `faff62a46d7a4764575bb8dc67786a9b42d9b1230f74a3ff94f80af1310369d3`; 1,425,356 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway chamber-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/chamber-2-42/legacy.ndjson.gz`. SHA256 `3ccb1c78f6fca51d9204f04c6d12c610261a04f5f79437582f202aa000844f20`; 1,286,146 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway chamber-2-42 --mode legacy --stage prescreen --limit 20
```
