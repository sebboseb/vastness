...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/narrow_passage-2-7/expanded.ndjson.gz`. SHA256 `20aac63d793a6f56b143a1795dde94629f93940755dc311e3af6d25c4482ff87`; 41,626 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway narrow_passage-2-7 --mode expanded --stage prescreen --limit 20
```
