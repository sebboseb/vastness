...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/doorway-2-42/expanded.ndjson.gz`. SHA256 `b6ad95c0c48d1ebbc8f60e9b8800d109aa0058f0298dc62ac230c15e26cf0e86`; 354,462 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway doorway-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/doorway-2-42/legacy.ndjson.gz`. SHA256 `add24878f68e4d303119cbfde9d3f64f4ecdca7f7d03c9ba33363dea08d45982`; 388,389 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway doorway-2-42 --mode legacy --stage prescreen --limit 20
```
