...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/bridge-1-42/expanded.ndjson.gz`. SHA256 `a050c69d0b833bf66f68c7dde08549720016c5b51631bbdee015c90b43d023ac`; 4,934,734 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway bridge-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/bridge-1-42/legacy.ndjson.gz`. SHA256 `b917520766ed03fe111833af53941a4d5f636a0dd1a0df5d381ad5111c523cfc`; 4,007,967 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway bridge-1-42 --mode legacy --stage prescreen --limit 20
```
