...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/corridor-1-42/expanded.ndjson.gz`. SHA256 `3baacd8508d14edb069c7ff4226bcb5f60826e420560271baba420c7cf6894c2`; 1,833,590 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway corridor-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/corridor-1-42/legacy.ndjson.gz`. SHA256 `aa76cf2a92e56d4a23af7320b5b179399b777b7999edd61be6391adbf6f23a90`; 2,245,282 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway corridor-1-42 --mode legacy --stage prescreen --limit 20
```
