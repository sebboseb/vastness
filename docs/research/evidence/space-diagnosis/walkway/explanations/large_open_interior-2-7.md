...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/large_open_interior-2-7/expanded.ndjson.gz`. SHA256 `e1102373bfb6c8cb9cccd76e3214bf616dfcebfe3cda552a7af50f688c6d7e14`; 318,845 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway large_open_interior-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/large_open_interior-2-7/legacy.ndjson.gz`. SHA256 `38c63431c355b023167ed905463fd235e5b7f1c52f3dc2252fdabb4d2e7c0cc7`; 291,662 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway large_open_interior-2-7 --mode legacy --stage prescreen --limit 20
```
