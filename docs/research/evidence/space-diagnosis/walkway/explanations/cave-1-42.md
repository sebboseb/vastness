...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/cave-1-42/expanded.ndjson.gz`. SHA256 `527d202f39c385e45d31243e1adea163ee69eef65627ec1ee660d352a0a22209`; 65,746 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway cave-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/cave-1-42/legacy.ndjson.gz`. SHA256 `dfb3b6c0df954e744933057ebc4144a933fd7f27b0faf75b0a07b4c5b84135c0`; 46,963 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway cave-1-42 --mode legacy --stage prescreen --limit 20
```
