...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/doorway-1-42/expanded.ndjson.gz`. SHA256 `2e01cdbdc818cefa61c5c40c5a296c6c693c37357d5220af21e30ee2a671706e`; 56,807 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway doorway-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/doorway-1-42/legacy.ndjson.gz`. SHA256 `923e0d4f21776e3b470bce512747a6b3493758d6a3c04676d1ec70feeefcc9c4`; 46,215 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway doorway-1-42 --mode legacy --stage prescreen --limit 20
```
