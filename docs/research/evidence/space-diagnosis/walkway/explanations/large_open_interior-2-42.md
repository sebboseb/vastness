...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/large_open_interior-2-42/expanded.ndjson.gz`. SHA256 `54fe2055b52641616edad28f43e3946e0564a66ff4b3e0a72774306f7888388a`; 327,028 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway large_open_interior-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/large_open_interior-2-42/legacy.ndjson.gz`. SHA256 `97140e5378f7ee699835f6ab2e61b644f40ce549117f553d47c20402a5ce96ad`; 307,047 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway large_open_interior-2-42 --mode legacy --stage prescreen --limit 20
```
