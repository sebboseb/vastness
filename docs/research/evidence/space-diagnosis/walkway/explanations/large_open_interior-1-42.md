...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/large_open_interior-1-42/expanded.ndjson.gz`. SHA256 `b7f90a2862d3abb68ec7d6491e27a86f1988c30fb690f0594419bfcd95a9ca61`; 519,041 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway large_open_interior-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/large_open_interior-1-42/legacy.ndjson.gz`. SHA256 `10beb27198cf5c3badb48022dd7c48f14140b192fe1cdb10c8cdcb00a13db7ef`; 685,762 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway large_open_interior-1-42 --mode legacy --stage prescreen --limit 20
```
