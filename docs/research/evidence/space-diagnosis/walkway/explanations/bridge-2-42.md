...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/bridge-2-42/expanded.ndjson.gz`. SHA256 `a5d18cf9d57720be6f5afb827dfae37cc542c904d24fa572c94361adccb78569`; 4,240,957 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway bridge-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/bridge-2-42/legacy.ndjson.gz`. SHA256 `b4fac84719f171716db67cb9831147300feffc4ed32d60cbf2da54b80ee3d565`; 5,363,806 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway bridge-2-42 --mode legacy --stage prescreen --limit 20
```
