...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/tunnel-1-7/expanded.ndjson.gz`. SHA256 `12634073aa7de8001034300ef17f0765165f18c29129f6658def97e91d81dc70`; 41,727 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway tunnel-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/tunnel-1-7/legacy.ndjson.gz`. SHA256 `f2c62f172b4a787a314b595ce310da049acccb69be7e211ec9f783a4d2b96dda`; 12,982 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway tunnel-1-7 --mode legacy --stage prescreen --limit 20
```
