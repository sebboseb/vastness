...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/chamber-2-7/expanded.ndjson.gz`. SHA256 `1e7f07e1b81d7d97aea3422375a4424096755f3002ec7af3f27fb8162328a7b9`; 601,757 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway chamber-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/chamber-2-7/legacy.ndjson.gz`. SHA256 `b90992b312d845f2b2f36b5bde0e81def93eb76f875338251b1d561a1eb7e0e4`; 569,884 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway chamber-2-7 --mode legacy --stage prescreen --limit 20
```
