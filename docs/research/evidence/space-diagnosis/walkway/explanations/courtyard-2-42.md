...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/courtyard-2-42/expanded.ndjson.gz`. SHA256 `1b876e8493bcf15fb7ca9d63c46bad4e7696f0491e0bd3dd157e408dd38f8bff`; 119,339 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway courtyard-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/courtyard-2-42/legacy.ndjson.gz`. SHA256 `5a06fa7603b5295c403f2bbe66313bbc9bdce56004d78800205ffa7af1f15c60`; 695,453 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway courtyard-2-42 --mode legacy --stage prescreen --limit 20
```
