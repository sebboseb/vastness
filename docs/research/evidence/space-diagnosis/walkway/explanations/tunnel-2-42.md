...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/tunnel-2-42/expanded.ndjson.gz`. SHA256 `9b59db8f8d850835f35309def4805c12efc7135bf7438bc52d70173004dcb5a4`; 1,907,673 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway tunnel-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/tunnel-2-42/legacy.ndjson.gz`. SHA256 `98609ceca0b23fdafae9df34ed9f1d6e63c65d75683f3d186342de658bbe995a`; 1,975,672 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway tunnel-2-42 --mode legacy --stage prescreen --limit 20
```
