...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/bridge-1-7/expanded.ndjson.gz`. SHA256 `6c8c87999be88d7d9c6345af1c89edf08917df8d48790af15baeece1364ec43c`; 4,394,234 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway bridge-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/bridge-1-7/legacy.ndjson.gz`. SHA256 `f6376bfc1aa155ef399276348a6ba4db07021d2a6da15a28367623ec57f29a84`; 4,956,791 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway bridge-1-7 --mode legacy --stage prescreen --limit 20
```
