...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/large_open_interior-1-7/expanded.ndjson.gz`. SHA256 `8967fe69afb6da7257c12a211e13ca04f17c00d542227667ca853fefcb92e4ac`; 827,545 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway large_open_interior-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/large_open_interior-1-7/legacy.ndjson.gz`. SHA256 `01e777ff598cf1e7d1b938eb76653b7ba629509e0845380611476f5274f2eb90`; 1,128,309 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway large_open_interior-1-7 --mode legacy --stage prescreen --limit 20
```
