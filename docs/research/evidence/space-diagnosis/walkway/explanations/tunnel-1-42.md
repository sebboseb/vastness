...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/tunnel-1-42/expanded.ndjson.gz`. SHA256 `c0124473bf0382b78eedb86b6f7d626d2f50767768e4192d86bdafdaa94d19d9`; 1,687,346 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway tunnel-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/tunnel-1-42/legacy.ndjson.gz`. SHA256 `ffd87be01b5e59b0ac183bb39fefb3b0a5dd137f58978cba2c07dfb447168f4d`; 1,785,206 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway tunnel-1-42 --mode legacy --stage prescreen --limit 20
```
