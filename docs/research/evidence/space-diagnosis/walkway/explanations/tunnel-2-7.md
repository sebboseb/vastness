...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/tunnel-2-7/expanded.ndjson.gz`. SHA256 `45804ee60f7e29337021942776f57c34b5f01589156306f9852a460fbca14793`; 354,357 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway tunnel-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/tunnel-2-7/legacy.ndjson.gz`. SHA256 `b12f61edce68f7a235a27ab71f9513f51414ea677367224a90456d21458eb014`; 978,214 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway tunnel-2-7 --mode legacy --stage prescreen --limit 20
```
