...
Complete trace: `.runtime/space-diagnosis/walkway/candidates/chamber-1-7/expanded.ndjson.gz`. SHA256 `51d234cc33e490adf5895c89e9dcb353eadfffc102c2af919a2f00d8f940eb6a`; 223,637 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway chamber-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/walkway/candidates/chamber-1-7/legacy.ndjson.gz`. SHA256 `55a51a120759d1918da6c0ca04c8a2258ba7bad10ec617850793559beab79deb`; 45,247 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py walkway chamber-1-7 --mode legacy --stage prescreen --limit 20
```
