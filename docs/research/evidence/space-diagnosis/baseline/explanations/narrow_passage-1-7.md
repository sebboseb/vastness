...
Complete trace: `.runtime/space-diagnosis/baseline/candidates/narrow_passage-1-7/expanded.ndjson.gz`. SHA256 `88b3f24abcd045479e9642634ba2c3a845a299aa6227aefa0325cda11a98f267`; 9,227 contiguous events.

| Stage | Observed outcome |
|---|---|
| Generated support | 384 valid sampled nodes; 859 floor tests |
| Proposals | 248 eligible; 70 attempted; 56 omitted by selection; 122 selected but not attempted |
| Pre-screen | {"source-projection": 47, "support-edge-not-found": 17, "body-obstruction": 2}; passed 4 |
| Components | 3 reached-entry discoveries, 182 distinct visited nodes; not exhaustive mesh decomposition |
...
```sh
python3 scripts/diagnosis/trace-query.py baseline narrow_passage-1-7 --mode expanded --stage prescreen --limit 20
```
