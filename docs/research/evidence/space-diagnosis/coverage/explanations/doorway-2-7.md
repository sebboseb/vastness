...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/doorway-2-7/expanded.ndjson.gz`. SHA256 `449d8664f37bafcf654843240daf2c9f0e632c914d3267d67cc3f09ca5b33bec`; 715,744 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage doorway-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/doorway-2-7/legacy.ndjson.gz`. SHA256 `3188cba6d5669dc8740e872111ae7acf0337ebcec79fb34c0435aae6fa6f5b01`; 599,529 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage doorway-2-7 --mode legacy --stage prescreen --limit 20
```
