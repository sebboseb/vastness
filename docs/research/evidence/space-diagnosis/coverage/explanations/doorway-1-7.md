...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/doorway-1-7/expanded.ndjson.gz`. SHA256 `d36055cd7de3104c696168ec93536ccb2ab630f703fc4fcf1caa652ef77a788e`; 695,174 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage doorway-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/doorway-1-7/legacy.ndjson.gz`. SHA256 `de496f1094c8be9fd80ca5c7dddf799402a87d0f22eac093be0ef64f7ebc5072`; 698,440 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage doorway-1-7 --mode legacy --stage prescreen --limit 20
```
