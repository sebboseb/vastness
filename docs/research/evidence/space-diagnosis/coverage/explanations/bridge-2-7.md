...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/bridge-2-7/expanded.ndjson.gz`. SHA256 `63c0e9bfb6ba5b61d13ce0697a40046dc703fc4141d16ffab34e05a4f3f852a0`; 1,977,179 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage bridge-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/bridge-2-7/legacy.ndjson.gz`. SHA256 `507d98d2f843b424add7a3a568a4785c0d047fd9861f2fec13f1396649e6fbe0`; 100,658 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage bridge-2-7 --mode legacy --stage prescreen --limit 20
```
