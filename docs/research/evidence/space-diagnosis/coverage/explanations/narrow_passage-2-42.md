...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/narrow_passage-2-42/expanded.ndjson.gz`. SHA256 `ba64011194bfad5e0e4fc2dfa9c578d0a55866017324c7ad40726bc54888bd45`; 53,877 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage narrow_passage-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/narrow_passage-2-42/legacy.ndjson.gz`. SHA256 `6926035d10965090c93bcab119e77b2747b9f253f2a9da1f98eab035e7d9ee25`; 48,288 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage narrow_passage-2-42 --mode legacy --stage prescreen --limit 20
```
