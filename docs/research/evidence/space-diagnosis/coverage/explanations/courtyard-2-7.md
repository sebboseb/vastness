...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/courtyard-2-7/expanded.ndjson.gz`. SHA256 `68eb4f2d7347d10a99ab2e72fe4e33492188e08a6696a2a1ae3b50f8a4fb099d`; 122,967 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage courtyard-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/courtyard-2-7/legacy.ndjson.gz`. SHA256 `b2e4833ebee4b06fd844239cdc2e80078e5174ef5fdf85309b3ecd9d828cc060`; 147,293 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage courtyard-2-7 --mode legacy --stage prescreen --limit 20
```
