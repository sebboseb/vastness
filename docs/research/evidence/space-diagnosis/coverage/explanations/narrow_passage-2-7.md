...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/narrow_passage-2-7/expanded.ndjson.gz`. SHA256 `581dfbbda64d77f99d38bd0f06b1ec6f234ccd3cb8f7539f7fa4b1de144c7a8f`; 41,626 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage narrow_passage-2-7 --mode expanded --stage prescreen --limit 20
```
