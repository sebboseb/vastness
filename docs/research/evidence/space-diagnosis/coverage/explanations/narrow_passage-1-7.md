...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/narrow_passage-1-7/expanded.ndjson.gz`. SHA256 `63fb3e42777d3608ccdae4a7655a3ac9f1eb1b3bb3612d3d5a7df5812aaf2a93`; 9,230 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage narrow_passage-1-7 --mode expanded --stage prescreen --limit 20
```
