...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/large_open_interior-1-42/expanded.ndjson.gz`. SHA256 `ff9793a1e11537190b4a08bfef420c57a50bbfa801632fa8cae5ac289476aca0`; 519,041 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage large_open_interior-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/large_open_interior-1-42/legacy.ndjson.gz`. SHA256 `44b281f21aaa42092e1a6f654b13d7e96ee790349616c9a9b220bf268ea2cc13`; 685,762 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage large_open_interior-1-42 --mode legacy --stage prescreen --limit 20
```
