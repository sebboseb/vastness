...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/courtyard-1-7/expanded.ndjson.gz`. SHA256 `78a35d6e702828aa6128e1116b32192fcad16524df7c09211e8e1d46d37864cf`; 335,503 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage courtyard-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/courtyard-1-7/legacy.ndjson.gz`. SHA256 `d0a4fa5d50c87892d18642fb54eda4950da8ee3b589ac1436c30356300daf91c`; 996,943 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage courtyard-1-7 --mode legacy --stage prescreen --limit 20
```
