...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/chamber-1-42/expanded.ndjson.gz`. SHA256 `6e77d548424d0f19b7053e4de426344842e9caf28b5caf85ab1536db14f7e75e`; 55,328 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage chamber-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/chamber-1-42/legacy.ndjson.gz`. SHA256 `f06caa4aafd4b0f2e41c2afdcad53e11051300b57b2740842174f3fd3ed2cf3e`; 46,983 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage chamber-1-42 --mode legacy --stage prescreen --limit 20
```
