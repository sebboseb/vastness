...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/corridor-1-42/expanded.ndjson.gz`. SHA256 `60af3acdf18cd8f75bf7acb4c2c5e4afddba87018e8c80271be2fdae6d2c5582`; 1,833,590 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage corridor-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/corridor-1-42/legacy.ndjson.gz`. SHA256 `e553953076adc433fcbbc51f78772835d38906ee11b9d46172d529963a583bb3`; 2,245,282 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage corridor-1-42 --mode legacy --stage prescreen --limit 20
```
