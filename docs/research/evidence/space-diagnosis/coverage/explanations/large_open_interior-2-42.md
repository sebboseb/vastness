...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/large_open_interior-2-42/expanded.ndjson.gz`. SHA256 `3220fe929e494af3f854ea334757fa058d2fd0b4b22d157b6a9591670d721e18`; 327,028 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage large_open_interior-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/large_open_interior-2-42/legacy.ndjson.gz`. SHA256 `55ca3e1f83e3e546750a050482b67c465d53171ca8a1499e076dc9adc6e02326`; 307,047 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage large_open_interior-2-42 --mode legacy --stage prescreen --limit 20
```
