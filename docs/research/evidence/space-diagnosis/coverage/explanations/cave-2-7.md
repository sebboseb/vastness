...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/cave-2-7/expanded.ndjson.gz`. SHA256 `a02783bba9970b0d48dd6476e58bb8aefe8b0618e024e34e402edd5ef4a4ef0d`; 81,339 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage cave-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/cave-2-7/legacy.ndjson.gz`. SHA256 `55ec51b0f90e6a72b2c599f34bb5b8609ac1f35e95df3e7e8055a10367aea018`; 79,460 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage cave-2-7 --mode legacy --stage prescreen --limit 20
```
