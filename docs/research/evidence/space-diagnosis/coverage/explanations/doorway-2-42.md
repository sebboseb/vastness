...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/doorway-2-42/expanded.ndjson.gz`. SHA256 `53e2b2c348fa0cdd744611f9f6197d811a45678992d76690ff113a493d6e5106`; 354,462 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage doorway-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/doorway-2-42/legacy.ndjson.gz`. SHA256 `b4291f7a72e6473eae5a67c9fc2ec27753a73cc7156ee5e9961452189fe29849`; 388,389 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage doorway-2-42 --mode legacy --stage prescreen --limit 20
```
