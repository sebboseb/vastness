...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/cave-1-7/expanded.ndjson.gz`. SHA256 `db1f68ca4d1e08f869e54dcd04f36a4f617f325538fd2110f3da4860a406ab46`; 179,057 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage cave-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: passed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/cave-1-7/legacy.ndjson.gz`. SHA256 `2d716fa57023094a52468fdbfe93aad068301433c560d6e21c660fb2a0c35d32`; 93,920 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage cave-1-7 --mode legacy --stage prescreen --limit 20
```
