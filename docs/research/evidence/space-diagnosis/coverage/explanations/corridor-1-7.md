...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/corridor-1-7/expanded.ndjson.gz`. SHA256 `79f21fa58edab3f852e4f3656205ac699ed3b2a29576fe4e866ec75b8b4e3670`; 137,547 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage corridor-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/corridor-1-7/legacy.ndjson.gz`. SHA256 `edfddd6b3931069a9e89d0642c84e9ce1a7a66db9f153309c0ea6f6da20334ee`; 468,288 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage corridor-1-7 --mode legacy --stage prescreen --limit 20
```
