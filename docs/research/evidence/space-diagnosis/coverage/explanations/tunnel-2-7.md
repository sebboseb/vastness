...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/tunnel-2-7/expanded.ndjson.gz`. SHA256 `30f1dd043b4bc9fb0627f84fced5216c33a7e419c1c39e585675f297e3c7b1b2`; 354,357 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage tunnel-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/tunnel-2-7/legacy.ndjson.gz`. SHA256 `ab1653d95f6d3ceb5149aa0b119b6e539ddedfaf9406384dd174712726884564`; 978,214 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage tunnel-2-7 --mode legacy --stage prescreen --limit 20
```
