...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/doorway-1-42/expanded.ndjson.gz`. SHA256 `59cd59f4e1b0db7c18218a118c01de840be1a6b2ec5e3c992685fc93571a69f1`; 56,807 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage doorway-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/doorway-1-42/legacy.ndjson.gz`. SHA256 `2a695e1afe6ac5b0da15323760592321d1f31c76f4993446ba663a7a72dea0ea`; 46,215 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage doorway-1-42 --mode legacy --stage prescreen --limit 20
```
