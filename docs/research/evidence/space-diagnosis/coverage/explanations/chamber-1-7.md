...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/chamber-1-7/expanded.ndjson.gz`. SHA256 `616a9379cf0bf886261e75b3a97c257ec16b827ec4271dd0f098ba39dbfe6100`; 223,637 contiguous events.
...
| Pre-screen | {"source-projection": 110, "support-edge-not-found": 213, "body-obstruction": 3, "entry-prism-blocked": 214, "source-entry-prism": 214}; passed 36 |
...
| Routes | All passes: 1802 candidate events. Returned pass: maximum connected displacement 6.2290m |
| Topology | {"enclosed-passage": 1802} |
| Final seam | {} |
...
```sh
python3 scripts/diagnosis/trace-query.py coverage chamber-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/chamber-1-7/legacy.ndjson.gz`. SHA256 `f5e413998478bc0daabc73d601af47ad01f0dfcac64b2a96e5373419a7f081e3`; 45,247 contiguous events.
...
|---|---|
| Generated support | 1141 valid sampled nodes; 1921 floor tests |
| Proposals | Returned pass: 185 eligible; 48 attempted. All trace passes: 411 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 40, "entry-prism-blocked": 80, "source-entry-prism": 80}; passed 24 |
...
| Routes | All passes: 6 candidate events. Returned pass: maximum connected displacement 3.2000m |
| Topology | {"enclosed-passage": 6} |
| Final seam | {} |
| Exhausted bounds | ["entry-proposals"] |
...
```sh
python3 scripts/diagnosis/trace-query.py coverage chamber-1-7 --mode legacy --stage prescreen --limit 20
```
