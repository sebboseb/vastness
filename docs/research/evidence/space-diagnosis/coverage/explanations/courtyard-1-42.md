...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/courtyard-1-42/expanded.ndjson.gz`. SHA256 `24fb6b5f8848397f1c0b35261fe5435fc924f09436adcb8b84c561571c077407`; 796,159 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage courtyard-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/courtyard-1-42/legacy.ndjson.gz`. SHA256 `939ae170a9f51bc0a670323a13e64cb068e0f3d78e6b9b40cd5c98f0174cd867`; 775,687 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage courtyard-1-42 --mode legacy --stage prescreen --limit 20
```
