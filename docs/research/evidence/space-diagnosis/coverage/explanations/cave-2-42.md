...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/cave-2-42/expanded.ndjson.gz`. SHA256 `6286b3c43ec9a66923eff801ebbbef4678c649d681ae1f5f3d7ef5e5725f2b27`; 51,852 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage cave-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/cave-2-42/legacy.ndjson.gz`. SHA256 `4594a53e2dbd84ebf60086765460d371a4a7aa1aad18bd5f5959cdd07feea325`; 24,538 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage cave-2-42 --mode legacy --stage prescreen --limit 20
```
