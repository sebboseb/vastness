...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/chamber-2-7/expanded.ndjson.gz`. SHA256 `c1bf513c454d1b1807d47a8383e598d9a453ae4611761fe9aecb02a990af5b78`; 601,757 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage chamber-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/chamber-2-7/legacy.ndjson.gz`. SHA256 `478fbd77bafcb89d1aad7c8b7cbd59fa4f4e35775067440925bf25a0f2075476`; 569,884 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage chamber-2-7 --mode legacy --stage prescreen --limit 20
```
