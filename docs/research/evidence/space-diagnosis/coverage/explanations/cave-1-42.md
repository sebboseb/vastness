...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/cave-1-42/expanded.ndjson.gz`. SHA256 `8656587815922dd0cc6aa5929ff89b93d291d35c6580274fda9cb61d706c35a8`; 65,746 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage cave-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/cave-1-42/legacy.ndjson.gz`. SHA256 `27f6b66d88cc5768d09738197948630877f2e4ffe19f5e724047a3b00d90ecc8`; 46,963 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage cave-1-42 --mode legacy --stage prescreen --limit 20
```
