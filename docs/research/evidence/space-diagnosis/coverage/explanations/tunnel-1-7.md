...
Complete trace: `.runtime/space-diagnosis/coverage/candidates/tunnel-1-7/expanded.ndjson.gz`. SHA256 `e19f97bd475cff4d364a278b9aebb23c32535bcc769d42434f3f6a6458406897`; 41,727 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage tunnel-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/coverage/candidates/tunnel-1-7/legacy.ndjson.gz`. SHA256 `9d377ba0536bf9181e45ed6c741433436295e36daffd2b798fcf30cbbaa20472`; 12,982 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py coverage tunnel-1-7 --mode legacy --stage prescreen --limit 20
```
