...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/cave-2-42/expanded.ndjson.gz`. SHA256 `04b86eba9c34b07af5f9b3d56d335e609af82b1220aed48ccfda3e486b791e0a`; 34,499 contiguous events.
...
| Proposals | Returned pass: 360 eligible; 192 attempted. All trace passes: 336 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 168, "support-edge-not-found": 42, "entry-prism-blocked": 162, "source-entry-prism": 162, "body-obstruction": 6}; passed 6 |
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism cave-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/cave-2-42/legacy.ndjson.gz`. SHA256 `8e16b25a53d2b184483fcbf13383fe96fc9ac9688d49aafad01bae68a67d1440`; 16,345 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism cave-2-42 --mode legacy --stage prescreen --limit 20
```
