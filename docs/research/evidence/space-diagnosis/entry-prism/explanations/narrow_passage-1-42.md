...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/narrow_passage-1-42/expanded.ndjson.gz`. SHA256 `bfa4a59b6d65e84ac45542ee8103ccef857008f2b718fb8dcff3f3faffa42e3a`; 34,922 contiguous events.
...
| Proposals | Returned pass: 364 eligible; 192 attempted. All trace passes: 344 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 174, "support-edge-not-found": 36, "entry-prism-blocked": 174, "source-entry-prism": 174}; passed 0 |
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism narrow_passage-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/narrow_passage-1-42/legacy.ndjson.gz`. SHA256 `11074998bdeda6105a53855272dfdaffe9939a672356a954ad057d111a69ab74`; 23,780 contiguous events.
...
|---|---|
| Generated support | 1155 valid sampled nodes; 1748 floor tests |
| Proposals | Returned pass: 62 eligible; 48 attempted. All trace passes: 28 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 48, "entry-prism-blocked": 48, "source-entry-prism": 48}; passed 0 |
| Components | Returned pass: 0 reached-entry discoveries. All passes: 0 distinct visited nodes; not exhaustive mesh decomposition |
| Routes | All passes: 0 candidate events. Returned pass: maximum connected displacement 0.0000m |
| Topology | {} |
| Final seam | {} |
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism narrow_passage-1-42 --mode legacy --stage prescreen --limit 20
```
