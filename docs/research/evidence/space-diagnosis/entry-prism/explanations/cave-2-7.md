...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/cave-2-7/expanded.ndjson.gz`. SHA256 `0a710aaab1db1a48910a0cc753f1468c3c5fb9d842c4bb0504698b779b25b885`; 53,958 contiguous events.
...
| Proposals | Returned pass: 276 eligible; 192 attempted. All trace passes: 168 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 148, "support-edge-not-found": 76, "body-obstruction": 4, "entry-prism-blocked": 148, "source-entry-prism": 148}; passed 8 |
| Components | Returned pass: 1 reached-entry discoveries. All passes: 210 distinct visited nodes; not exhaustive mesh decomposition |
| Routes | All passes: 310 candidate events. Returned pass: maximum connected displacement 4.6043m |
| Topology | {"enclosed-passage": 310} |
| Final seam | {} |
...
```json
{
  "opposing-wall-width": 7490,
  "broad-supported-region": 6
}
```
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism cave-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/cave-2-7/legacy.ndjson.gz`. SHA256 `7e16dc28fc6c2d5d5fe65b2c4fb53afc168211b7370fb51b666c15d898b718a1`; 52,537 contiguous events.
...
| Pre-screen | {"source-projection": 23, "entry-prism-blocked": 23, "source-entry-prism": 23}; passed 8 |
| Components | Returned pass: 1 reached-entry discoveries. All passes: 210 distinct visited nodes; not exhaustive mesh decomposition |
| Routes | All passes: 626 candidate events. Returned pass: maximum connected displacement 4.6043m |
| Topology | {"enclosed-passage": 626} |
| Final seam | {} |
| Exhausted bounds | [] |
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism cave-2-7 --mode legacy --stage prescreen --limit 20
```
