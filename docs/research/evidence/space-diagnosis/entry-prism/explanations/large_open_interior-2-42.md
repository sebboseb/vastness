...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/large_open_interior-2-42/expanded.ndjson.gz`. SHA256 `c0c13e5eacd27ad59c1a5cc8cf02bc6327d240c84f12daeaacff16bd074db297`; 217,959 contiguous events.
...
| Proposals | Returned pass: 966 eligible; 192 attempted. All trace passes: 1548 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"support-edge-not-found": 32, "source-projection": 176, "entry-prism-blocked": 175, "source-entry-prism": 175, "exterior-approach-limit": 1}; passed 0 |
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism large_open_interior-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/large_open_interior-2-42/legacy.ndjson.gz`. SHA256 `fa9ef02cff1959fa29beccca1325106946e0199cdefc5c5fd161c1f13a07d8c7`; 204,696 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism large_open_interior-2-42 --mode legacy --stage prescreen --limit 20
```
