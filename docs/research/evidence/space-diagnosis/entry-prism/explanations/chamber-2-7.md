...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/chamber-2-7/expanded.ndjson.gz`. SHA256 `b34288028e07f0bd91a09f34f5a05ec05918c4c6986a84aaa5e72be8f9a75efc`; 305,951 contiguous events.
...
| Proposals | Returned pass: 256 eligible; 192 attempted. All trace passes: 128 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 176, "support-edge-not-found": 32, "entry-prism-blocked": 159, "source-entry-prism": 159}; passed 17 |
| Components | Returned pass: 1 reached-entry discoveries. All passes: 729 distinct visited nodes; not exhaustive mesh decomposition |
| Routes | All passes: 3818 candidate events. Returned pass: maximum connected displacement 6.8118m |
| Topology | {"enclosed-passage": 3818} |
| Final seam | {} |
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism chamber-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/chamber-2-7/legacy.ndjson.gz`. SHA256 `3b2292247d124eae33a4b3e877ed1a76b80748e739bde57ee5c4763106d8455d`; 299,825 contiguous events.
...
|---|---|
| Generated support | 1401 valid sampled nodes; 1688 floor tests |
| Proposals | Returned pass: 200 eligible; 34 attempted. All trace passes: 304 omitted by selection; 14 selected but not attempted |
| Pre-screen | {"source-projection": 48, "entry-prism-blocked": 24, "source-entry-prism": 24}; passed 10 |
| Components | Returned pass: 1 reached-entry discoveries. All passes: 729 distinct visited nodes; not exhaustive mesh decomposition |
| Routes | All passes: 4096 candidate events. Returned pass: maximum connected displacement 6.6843m |
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism chamber-2-7 --mode legacy --stage prescreen --limit 20
```
