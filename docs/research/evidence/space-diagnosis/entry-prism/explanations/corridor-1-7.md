...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/corridor-1-7/expanded.ndjson.gz`. SHA256 `2d63e8e18def88cabb511b2beee4ea662415fbe1384b17256b0466e1f1654584`; 91,475 contiguous events.
...
| Proposals | Returned pass: 560 eligible; 192 attempted. All trace passes: 736 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 131, "support-edge-not-found": 114, "entry-prism-blocked": 131, "source-entry-prism": 131}; passed 8 |
...
| Routes | All passes: 258 candidate events. Returned pass: maximum connected displacement 5.4037m |
| Topology | {"doorway-crossing": 254} |
...
```json
{
  "required-roof-coverage": 2198,
  "roof-coverage": 1962,
  "left-flank": 4628,
  "region-does-not-widen": 2348,
  "opposite-crossing-sides": 516
}
```
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism corridor-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/corridor-1-7/legacy.ndjson.gz`. SHA256 `ce5e543ff8a3eb449bd18589efa6784d6e0e4d9dd67dd179b3ecf632a9246b89`; 310,950 contiguous events.
...
|---|---|
| Generated support | 1294 valid sampled nodes; 2084 floor tests |
| Proposals | Returned pass: 100 eligible; 48 attempted. All trace passes: 104 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 38, "entry-prism-blocked": 38, "source-entry-prism": 38}; passed 20 |
...
| Routes | All passes: 1830 candidate events. Returned pass: maximum connected displacement 5.4000m |
| Topology | {"doorway-crossing": 1814} |
| Final seam | {"swept-forward:support-gap-or-step": 16, "swept-reverse:support-gap-or-step": 16} |
| Exhausted bounds | ["entry-proposals"] |
...
```json
{
  "required-roof-coverage": 14242,
  "roof-coverage": 12484,
  "left-flank": 32672,
  "region-does-not-widen": 16640,
  "opposite-crossing-sides": 3492
}
```
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism corridor-1-7 --mode legacy --stage prescreen --limit 20
```
