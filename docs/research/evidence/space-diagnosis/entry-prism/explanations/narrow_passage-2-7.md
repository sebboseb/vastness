...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/narrow_passage-2-7/expanded.ndjson.gz`. SHA256 `7aa9e2816fc30e6f22fb85dba43e087b7cb2514209d9ffef3439a23dd978187d`; 41,624 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism narrow_passage-2-7 --mode expanded --stage prescreen --limit 20
```
