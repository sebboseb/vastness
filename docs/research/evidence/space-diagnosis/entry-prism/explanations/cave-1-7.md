...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/cave-1-7/expanded.ndjson.gz`. SHA256 `d7806f174cc144bae5080f6bc54dd60b761c559d8316e1e0a368f23800cbf3a7`; 118,782 contiguous events.
...
| Proposals | Returned pass: 810 eligible; 192 attempted. All trace passes: 1236 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 162, "support-edge-not-found": 52, "entry-prism-blocked": 162, "source-entry-prism": 162}; passed 8 |
...
| Routes | All passes: 798 candidate events. Returned pass: maximum connected displacement 5.6886m |
| Topology | {"enclosed-passage": 790} |
| Final seam | {"swept-forward:support-gap-or-step": 6, "swept-reverse:support-gap-or-step": 8, "swept-forward:unsupported-footprint": 2} |
...
```json
{
  "opposing-wall-width": 14160,
  "broad-supported-region": 7916,
  "roof-coverage": 78
}
```
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism cave-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: passed

Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/cave-1-7/legacy.ndjson.gz`. SHA256 `50c8da5cc47da4709baacdbfdd484588cec2e7ee039062a4cfbcc6b925d94e6f`; 93,918 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism cave-1-7 --mode legacy --stage prescreen --limit 20
```
