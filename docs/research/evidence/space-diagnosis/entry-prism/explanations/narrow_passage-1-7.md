...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/narrow_passage-1-7/expanded.ndjson.gz`. SHA256 `2905de5c44a89e87664225841c268bc906cef077b2022c93643b9457496f198f`; 9,228 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism narrow_passage-1-7 --mode expanded --stage prescreen --limit 20
```
