...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/chamber-1-42/expanded.ndjson.gz`. SHA256 `22bdfbea59ecf4ea58ff1797618e81bed4673b7a65f61106dd7a1b1494183f12`; 36,821 contiguous events.
...
| Pre-screen | {"source-projection": 187, "support-edge-not-found": 10, "entry-prism-blocked": 187, "source-entry-prism": 187}; passed 0 |
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism chamber-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/chamber-1-42/legacy.ndjson.gz`. SHA256 `ef56338cc715d8cf215d93de3a68da7c3547df41aedd53e0b6a291f41c45fd6f`; 31,304 contiguous events.
...
|---|---|
| Generated support | 1383 valid sampled nodes; 2229 floor tests |
| Proposals | Returned pass: 199 eligible; 48 attempted. All trace passes: 302 omitted by selection; 0 selected but not attempted |
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism chamber-1-42 --mode legacy --stage prescreen --limit 20
```
