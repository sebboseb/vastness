...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/cave-1-42/expanded.ndjson.gz`. SHA256 `ecde0d4b82b0bd54988b12994be9ae4c6a72b02c74797f07f7aebcaa3f83e54e`; 43,651 contiguous events.
...
| Proposals | Returned pass: 688 eligible; 192 attempted. All trace passes: 992 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 154, "support-edge-not-found": 74, "entry-prism-blocked": 152, "source-entry-prism": 152, "body-obstruction": 1}; passed 3 |
...
```json
{
  ...
  "baseline": {
    ...
    "prescreen:rejected": 154,
    "prescreen:body-sample": 38,
    "prescreen:passed": 1,
    "component:entry-search": 1,
    "component:node-visited": 63,
    "edge:tested": 120,
    "component:node-discovered": 62,
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism cave-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/cave-1-42/legacy.ndjson.gz`. SHA256 `20c429086f1b9dd9c79ac22f5c20c7d711d325a4febe00bed0dcc1a3653be07e`; 30,871 contiguous events.
...
|---|---|
| Generated support | 1157 valid sampled nodes; 2501 floor tests |
| Proposals | Returned pass: 69 eligible; 48 attempted. All trace passes: 42 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 42, "entry-prism-blocked": 36, "source-entry-prism": 36}; passed 18 |
| Components | Returned pass: 2 reached-entry discoveries. All passes: 125 distinct visited nodes; not exhaustive mesh decomposition |
...
```json
{
  ...
  "baseline": {
    ...
    "component:node-visited": 378,
    "edge:tested": 120,
    "component:node-discovered": 372,
    "result:assessment-complete": 1,
    "result:entry-pass-complete": 1
  },
  "entry-prism": {
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism cave-1-42 --mode legacy --stage prescreen --limit 20
```
