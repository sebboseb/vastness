...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/doorway-1-42/expanded.ndjson.gz`. SHA256 `23ccfa4f8ab04af66021b720a1cd4d0036472a120b73b4fb2d4b3cd775973500`; 37,833 contiguous events.
...
| Pre-screen | {"source-projection": 109, "support-edge-not-found": 166, "entry-prism-blocked": 109, "source-entry-prism": 109}; passed 0 |
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism doorway-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/doorway-1-42/legacy.ndjson.gz`. SHA256 `b1c20d178214827c422e8f976b7876bd002aac98c90d9f95f10e848a68852fb1`; 30,792 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism doorway-1-42 --mode legacy --stage prescreen --limit 20
```
