...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/narrow_passage-2-42/expanded.ndjson.gz`. SHA256 `fdbb3edf30fb8f77178083133527236a47e1d4a7de9134655d354623bf3e705b`; 35,852 contiguous events.
...
| Proposals | Returned pass: 216 eligible; 192 attempted. All trace passes: 48 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 192, "entry-prism-blocked": 192, "source-entry-prism": 192}; passed 0 |
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism narrow_passage-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/narrow_passage-2-42/legacy.ndjson.gz`. SHA256 `b4d263559afe847db77a2162af0ee0601914531a1355e17fda0ad37c2b0958a7`; 32,174 contiguous events.
...
|---|---|
| Generated support | 1458 valid sampled nodes; 1737 floor tests |
| Proposals | Returned pass: 200 eligible; 48 attempted. All trace passes: 304 omitted by selection; 0 selected but not attempted |
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism narrow_passage-2-42 --mode legacy --stage prescreen --limit 20
```
