...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/tunnel-1-42/expanded.ndjson.gz`. SHA256 `d0fba6f345157528c0a6fa4dfe577bc7bd66f163c7032f20c79f4d715900f5aa`; 1,120,296 contiguous events.
...
| Proposals | Returned pass: 1092 eligible; 192 attempted. All trace passes: 1800 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 162, "support-edge-not-found": 50, "entry-prism-blocked": 121, "source-entry-prism": 121, "exterior-approach-limit": 41}; passed 10 |
| Components | Returned pass: 1 reached-entry discoveries. All passes: 1538 distinct visited nodes; not exhaustive mesh decomposition |
| Routes | All passes: 6862 candidate events. Returned pass: maximum connected displacement 19.4618m |
| Topology | {"enclosed-passage": 6862} |
| Final seam | {} |
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism tunnel-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/tunnel-1-42/legacy.ndjson.gz`. SHA256 `fa306ffc6c52f1970137390a75c550573853671f044ae828167e1f1d6779c0b9`; 1,293,512 contiguous events.
...
|---|---|
| Generated support | 5726 valid sampled nodes; 11037 floor tests |
| Proposals | Returned pass: 526 eligible; 43 attempted. All trace passes: 956 omitted by selection; 10 selected but not attempted |
| Pre-screen | {"source-projection": 39, "entry-prism-blocked": 37, "source-entry-prism": 37}; passed 10 |
...
| Routes | All passes: 8192 candidate events. Returned pass: maximum connected displacement 19.9650m |
| Topology | {"enclosed-passage": 8190} |
...
```json
{
  "opposing-wall-width": 545960,
  "broad-supported-region": 43
}
```
...
```json
{
  ...
  "baseline": {
    ...
    "budget:exhausted": 2,
    "proposal:attempt": 43,
    "prescreen:edge-support-probe": 1925,
    "prescreen:projection-start": 43,
    "prescreen:projection-blocked": 39,
    "prescreen:rejected": 39,
    "prescreen:body-sample": 168,
    "prescreen:passed": 4,
    "component:entry-search": 4,
    "component:node-visited": 4837,
    "edge:tested": 3003,
    "component:node-discovered": 4846,
    "route:candidate": 4096,
    "topology:ray": 19721,
    "topology:node-feature": 1517,
    "topology:node-predicate": 273020,
    "topology:sustained-sample": 273020,
    "topology:sustained-result": 4096,
    "topology:route-rejected": 4096,
    "route:candidate-not-executed": 1,
    "proposal:not-attempted": 5,
    "result:assessment-complete": 1,
    "result:entry-pass-complete": 1
  },
  "entry-prism": {
    ...
    "component:node-visited": 5296,
    "edge:tested": 4001,
    "component:node-discovered": 5352,
    "route:candidate": 4096,
    "topology:ray": 20397,
    "topology:node-feature": 1569,
    "topology:broad-feature": 52,
    "topology:node-predicate": 273007,
    "topology:sustained-sample": 273007,
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism tunnel-1-42 --mode legacy --stage prescreen --limit 20
```
