...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/courtyard-2-7/expanded.ndjson.gz`. SHA256 `1a491ac4e0ce2f2df2c1ff570f64bd794e7593f200080c64b235b1937f2ef36d`; 81,577 contiguous events.
...
| Proposals | Returned pass: 356 eligible; 192 attempted. All trace passes: 328 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 127, "support-edge-not-found": 126, "entry-prism-blocked": 127, "source-entry-prism": 127}; passed 4 |
| Components | Returned pass: 1 reached-entry discoveries. All passes: 454 distinct visited nodes; not exhaustive mesh decomposition |
| Routes | All passes: 528 candidate events. Returned pass: maximum connected displacement 6.6483m |
| Topology | {"open-courtyard": 528} |
| Final seam | {} |
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism courtyard-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/courtyard-2-7/legacy.ndjson.gz`. SHA256 `55c23f378f8e54faa5cea754f718499949140c87f49fcf588f774adf0712e982`; 97,524 contiguous events.
...
|---|---|
| Generated support | 644 valid sampled nodes; 1214 floor tests |
| Proposals | Returned pass: 174 eligible; 48 attempted. All trace passes: 252 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 46, "entry-prism-blocked": 46, "source-entry-prism": 46}; passed 4 |
| Components | Returned pass: 1 reached-entry discoveries. All passes: 454 distinct visited nodes; not exhaustive mesh decomposition |
| Routes | All passes: 974 candidate events. Returned pass: maximum connected displacement 6.2482m |
| Topology | {"open-courtyard": 974} |
| Final seam | {} |
| Exhausted bounds | ["entry-proposals"] |
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism courtyard-2-7 --mode legacy --stage prescreen --limit 20
```
