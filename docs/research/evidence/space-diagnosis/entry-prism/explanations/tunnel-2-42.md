...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/tunnel-2-42/expanded.ndjson.gz`. SHA256 `ad0b52d0defe15196491c674e0ede80629cad6ce384b091110f5807550d00247`; 1,158,013 contiguous events.
...
| Proposals | Returned pass: 1862 eligible; 192 attempted. All trace passes: 3340 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 161, "support-edge-not-found": 60, "entry-prism-blocked": 111, "source-entry-prism": 111, "exterior-approach-limit": 49}; passed 3 |
...
| Routes | All passes: 5647 candidate events. Returned pass: maximum connected displacement 21.4960m |
| Topology | {"enclosed-passage": 5647} |
| Final seam | {} |
...
```json
{
  ...
  "baseline": {
    ...
    "prescreen:rejected": 161,
    "prescreen:support-edge-not-found": 30,
    "prescreen:body-sample": 38,
    "prescreen:passed": 1,
    "component:entry-search": 1,
    "component:node-visited": 4061,
    "edge:tested": 13625,
    "component:node-discovered": 4060,
    "route:candidate": 1859,
    "topology:ray": 49660,
    "topology:node-feature": 3820,
    "topology:node-predicate": 137979,
    "topology:sustained-sample": 137979,
    "topology:sustained-result": 1859,
    "topology:route-rejected": 1859,
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism tunnel-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/tunnel-2-42/legacy.ndjson.gz`. SHA256 `7641d519103eb3a5dc08b94bdef6aba92f4dafb453a075a23301aad8efd11f27`; 1,518,744 contiguous events.
...
|---|---|
| Generated support | 7207 valid sampled nodes; 11499 floor tests |
| Proposals | Returned pass: 491 eligible; 12 attempted. All trace passes: 886 omitted by selection; 70 selected but not attempted |
| Pre-screen | {"source-projection": 12, "entry-prism-blocked": 10, "source-entry-prism": 10}; passed 4 |
| Components | Returned pass: 1 reached-entry discoveries. All passes: 4061 distinct visited nodes; not exhaustive mesh decomposition |
| Routes | All passes: 8192 candidate events. Returned pass: maximum connected displacement 21.4960m |
...
```json
{
  ...
  "baseline": {
    ...
    "budget:exhausted": 2,
    "proposal:attempt": 14,
    "prescreen:edge-support-probe": 632,
    "prescreen:projection-start": 14,
    "prescreen:projection-blocked": 12,
    "prescreen:rejected": 12,
    "prescreen:body-sample": 84,
    "prescreen:passed": 2,
    "component:entry-search": 2,
    "component:node-visited": 4772,
    "edge:tested": 13625,
    "component:node-discovered": 4813,
    "route:candidate": 4096,
    "topology:ray": 52013,
    "topology:node-feature": 4001,
    "topology:node-predicate": 292920,
    "topology:sustained-sample": 292920,
    "topology:sustained-result": 4096,
    "topology:route-rejected": 4096,
    "route:candidate-not-executed": 1,
    "proposal:not-attempted": 34,
    "result:assessment-complete": 1,
    "result:entry-pass-complete": 1
  },
  "entry-prism": {
    ...
    "budget:exhausted": 2,
    "proposal:attempt": 12,
    "prescreen:edge-support-probe": 540,
    "prescreen:projection-start": 12,
    "prescreen:entry-prism-proof": 12,
    "prescreen:body-sample": 80,
    "prescreen:passed": 2,
    "component:entry-search": 2,
    "component:node-visited": 4585,
    "edge:tested": 13625,
    "component:node-discovered": 4618,
    "route:candidate": 4096,
    "topology:ray": 52793,
    "topology:node-feature": 4061,
    "topology:node-predicate": 316398,
    "topology:sustained-sample": 316398,
    "topology:sustained-result": 4096,
    "topology:route-rejected": 4096,
    "prescreen:entry-prism-blocked": 10,
    "prescreen:rejected": 10,
    "route:candidate-not-executed": 1,
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism tunnel-2-42 --mode legacy --stage prescreen --limit 20
```
