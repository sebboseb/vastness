...
Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/large_open_interior-1-42/expanded.ndjson.gz`. SHA256 `0de1aef258d2efa6081f78208d6807953f57c013be112848795d6c43a973b994`; 268,661 contiguous events.
...
| Proposals | Returned pass: 458 eligible; 192 attempted. All trace passes: 532 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 163, "support-edge-not-found": 56, "body-obstruction": 4, "entry-prism-blocked": 152, "source-entry-prism": 152}; passed 9 |
...
| Routes | All passes: 2824 candidate events. Returned pass: maximum connected displacement 9.4594m |
| Topology | {"broad-covered-interior": 2824} |
| Final seam | {} |
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism large_open_interior-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/entry-prism/candidates/large_open_interior-1-42/legacy.ndjson.gz`. SHA256 `5ce40a754826787ffbf5c946af67c4c45ba74c5c3a140d9277b7e7cb80002581`; 368,786 contiguous events.
...
|---|---|
| Generated support | 1969 valid sampled nodes; 3288 floor tests |
| Proposals | Returned pass: 80 eligible; 30 attempted. All trace passes: 64 omitted by selection; 18 selected but not attempted |
| Pre-screen | {"source-projection": 48, "entry-prism-blocked": 23, "source-entry-prism": 23}; passed 7 |
| Components | Returned pass: 1 reached-entry discoveries. All passes: 967 distinct visited nodes; not exhaustive mesh decomposition |
| Routes | All passes: 4096 candidate events. Returned pass: maximum connected displacement 9.5603m |
...
```json
{
  ...
  "entry-prism": {
    ...
    "budget:exhausted": 2,
    "proposal:attempt": 30,
    "prescreen:edge-support-probe": 1386,
    "prescreen:projection-start": 30,
...
```sh
python3 scripts/diagnosis/trace-query.py entry-prism large_open_interior-1-42 --mode legacy --stage prescreen --limit 20
```
