...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/chamber-2-42/expanded.ndjson.gz`. SHA256 `54a0c115d3f967c3c6d517e73c28466171d001e75a714339ef74e4bda833c674`; 1,425,356 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope chamber-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/chamber-2-42/legacy.ndjson.gz`. SHA256 `4a7823f63fc47592dcdfd73ac7757750d026bd427529964bd98af97825c2c843`; 1,286,146 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope chamber-2-42 --mode legacy --stage prescreen --limit 20
```
