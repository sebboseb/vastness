...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/cave-2-42/expanded.ndjson.gz`. SHA256 `5029dd1b460c182595d2a7697fc177177fcd9d7444dd3b2c40e33e50499ca2c3`; 51,852 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope cave-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/cave-2-42/legacy.ndjson.gz`. SHA256 `5ac96a6060c318a105bc67368705efda3799810ec96ec95015bc08e675c061fd`; 24,538 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope cave-2-42 --mode legacy --stage prescreen --limit 20
```
