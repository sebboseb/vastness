...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/cave-1-7/expanded.ndjson.gz`. SHA256 `a551c0363f799857bab99625fa08055eddaae395f35d6a44efe16ef3b3a7e180`; 179,057 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope cave-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: passed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/cave-1-7/legacy.ndjson.gz`. SHA256 `09d21f9c32d27dbc02b0e694f2bef9b8086303d92e53c5b7a84f28004613eac1`; 93,920 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope cave-1-7 --mode legacy --stage prescreen --limit 20
```
