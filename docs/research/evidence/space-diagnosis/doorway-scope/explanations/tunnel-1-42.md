...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/tunnel-1-42/expanded.ndjson.gz`. SHA256 `1f942001bdc8d0660c31be1d2370566c695b750ebc2679efac3d39747082b609`; 1,687,346 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope tunnel-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/tunnel-1-42/legacy.ndjson.gz`. SHA256 `71820dc5b2028eee8fe58e7f5498760bc345fb62c616a35a97e8171668fcc9b0`; 1,785,206 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope tunnel-1-42 --mode legacy --stage prescreen --limit 20
```
