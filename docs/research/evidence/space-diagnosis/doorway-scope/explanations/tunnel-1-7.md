...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/tunnel-1-7/expanded.ndjson.gz`. SHA256 `ea008c6150f4bd09d94dd6b333ce5bba4b271b292ad4ac8bcfc98d97daa30ddb`; 41,727 contiguous events.
...
| Proposals | Returned pass: 226 eligible; 192 attempted. All trace passes: 102 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 164, "support-edge-not-found": 81, "entry-prism-blocked": 328, "source-entry-prism": 328}; passed 3 |
...
```json
{
  ...
  "predecessor": {
    ...
    "proposal:eligible": 452,
    "proposal:direction-excluded": 2268,
    "proposal:rank-selection": 384,
    "proposal:selected": 384,
    "proposal:omitted": 68,
    "budget:exhausted": 2,
    "proposal:attempt": 384,
    "prescreen:edge-support-probe": 19418,
    "prescreen:projection-start": 330,
    "prescreen:projection-blocked": 164,
    "prescreen:rejected": 328,
    "prescreen:support-edge-not-found": 54,
    "prescreen:body-sample": 94,
    "prescreen:passed": 2,
    "component:entry-search": 2,
    "component:node-visited": 6,
    "edge:tested": 30,
    "component:node-discovered": 4,
  ...
  "coverage-round-robin": {
    ...
    "prescreen:passed": 1,
    "route:stream-admitted": 1,
    "route:scheduler-start": 1,
    "route:stream-resumed": 1,
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope tunnel-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/tunnel-1-7/legacy.ndjson.gz`. SHA256 `0495e1afd1bf75f21fce615adc884a23479590a342839fa1f65d101aea58333e`; 12,982 contiguous events.
...
| Pre-screen | {"source-projection": 19, "entry-prism-blocked": 38, "source-entry-prism": 38}; passed 3 |
...
```json
{
  ...
  "predecessor": {
    ...
    "support:node": 680,
    "support:duplicate-layer": 6,
    "proposal:direction-excluded": 2664,
    "proposal:legacy-body-sample": 830,
    "proposal:eligible": 40,
    "proposal:direction-unexecuted": 16,
    "proposal:selected": 40,
    "proposal:attempt": 40,
    "prescreen:edge-support-probe": 1734,
    "prescreen:projection-start": 40,
    "prescreen:projection-blocked": 19,
    "prescreen:rejected": 38,
    "prescreen:body-sample": 78,
    "prescreen:passed": 2,
    "component:entry-search": 2,
    "component:node-visited": 2,
    "edge:tested": 4,
    "result:assessment-complete": 2,
    "result:entry-pass-complete": 2,
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope tunnel-1-7 --mode legacy --stage prescreen --limit 20
```
