...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/bridge-2-42/expanded.ndjson.gz`. SHA256 `adc88a5678975246a738ec36bdf3bdca2dbacf02926d4bd4fece2f3a60b757ca`; 4,240,957 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope bridge-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/bridge-2-42/legacy.ndjson.gz`. SHA256 `2851b0965795efefeb5e7895b22d2b85ac7038aaa24d627f69dc1953422621f0`; 5,363,806 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope bridge-2-42 --mode legacy --stage prescreen --limit 20
```
