...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/doorway-2-42/expanded.ndjson.gz`. SHA256 `1dd62bf93c46b884a01b10a5e7b25ac9b190529681db08a251a42082489b3985`; 354,462 contiguous events.
...
| Pre-screen | {"support-edge-not-found": 54, "source-projection": 141, "entry-prism-blocked": 280, "source-entry-prism": 280}; passed 101 |
| Components | Returned pass: 5 reached-entry discoveries. All passes: 394 distinct visited nodes; not exhaustive mesh decomposition |
| Routes | All passes: 7368 candidate events. Returned pass: maximum connected displacement 6.2129m |
| Topology | {"doorway-crossing": 7368} |
| Final seam | {} |
...
```json
{
  ...
  "predecessor": {
    ...
    "support:grid": 2,
    "support:column": 1984,
    "support:rejected": 1182,
    "support:node": 880,
    "proposal:eligible": 440,
    "proposal:direction-excluded": 3080,
    "proposal:rank-selection": 384,
    "proposal:selected": 384,
    "proposal:omitted": 56,
    "budget:exhausted": 2,
    "proposal:attempt": 384,
    "prescreen:edge-support-probe": 17888,
    "prescreen:support-edge-not-found": 36,
    "prescreen:projection-start": 348,
    "prescreen:projection-blocked": 141,
    "prescreen:rejected": 281,
    "prescreen:body-sample": 2580,
    "prescreen:passed": 67,
    "component:entry-search": 67,
    "component:node-visited": 21082,
    "edge:tested": 1442,
    "component:node-discovered": 21015,
    "route:candidate": 4912,
    "topology:ray": 20504,
    "topology:node-feature": 720,
    "topology:aperture-node": 122206,
    "topology:route-rejected": 4912,
    "topology:aperture-axis": 5572,
  ...
  "coverage-round-robin": {
    ...
    "prescreen:passed": 34,
    "route:stream-admitted": 34,
    "route:scheduler-start": 1,
    "route:stream-resumed": 2490,
    ...
    "route:stream-suspended": 2456,
    "topology:aperture-axis": 2786,
    "route:stream-complete": 34,
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope doorway-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/doorway-2-42/legacy.ndjson.gz`. SHA256 `4d9f25b85f4fc1caccb408bb53e637ec1bf7a9d3e53915371a92d7a19e02dbe3`; 388,389 contiguous events.
...
|---|---|
| Generated support | 440 valid sampled nodes; 1031 floor tests |
| Proposals | Returned pass: 104 eligible; 48 attempted. All trace passes: 168 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 25, "entry-prism-blocked": 50, "source-entry-prism": 50}; passed 69 |
| Components | Returned pass: 3 reached-entry discoveries. All passes: 382 distinct visited nodes; not exhaustive mesh decomposition |
| Routes | All passes: 9756 candidate events. Returned pass: maximum connected displacement 6.2129m |
| Topology | {"doorway-crossing": 9756} |
| Final seam | {} |
| Exhausted bounds | ["entry-proposals"] |
...
```json
{
  ...
  "predecessor": {
    ...
    "support:rejected": 1182,
    "support:node": 880,
    "proposal:direction-excluded": 3046,
    "proposal:legacy-body-sample": 3816,
    "proposal:eligible": 208,
    "proposal:direction-unexecuted": 266,
    "proposal:selected": 96,
    "proposal:omitted": 112,
    "budget:exhausted": 2,
    "proposal:attempt": 96,
    "prescreen:edge-support-probe": 4368,
    "prescreen:projection-start": 96,
    "prescreen:body-sample": 1866,
    "prescreen:passed": 46,
    "component:entry-search": 46,
    "component:node-visited": 15778,
    "edge:tested": 1414,
    "component:node-discovered": 15732,
    "route:candidate": 6504,
    "topology:ray": 23438,
    "topology:node-feature": 726,
    "topology:aperture-node": 159160,
    "topology:aperture-axis": 7000,
    "topology:route-rejected": 6504,
  ...
  "coverage-round-robin": {
    ...
    "prescreen:passed": 23,
    "route:stream-admitted": 23,
    "prescreen:entry-prism-blocked": 25,
    "prescreen:rejected": 25,
    "route:scheduler-start": 1,
    "route:stream-resumed": 3275,
    ...
    "route:stream-suspended": 3252,
    "route:stream-complete": 23,
    "route:scheduler-complete": 1,
    "result:assessment-complete": 1,
    "result:coverage-pass-complete": 1
  }
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope doorway-2-42 --mode legacy --stage prescreen --limit 20
```
