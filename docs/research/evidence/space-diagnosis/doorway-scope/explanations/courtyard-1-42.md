...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/courtyard-1-42/expanded.ndjson.gz`. SHA256 `6790f951721204b46c8dc1f33754dcdb9f0ccbbe6969c128f877c12058b0d295`; 796,159 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope courtyard-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/courtyard-1-42/legacy.ndjson.gz`. SHA256 `1ab266eda16fa792c8c673b27331a2a960b8bdcecdcf01a12945f298e969075f`; 775,687 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope courtyard-1-42 --mode legacy --stage prescreen --limit 20
```
