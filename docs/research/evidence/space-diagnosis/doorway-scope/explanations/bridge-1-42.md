...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/bridge-1-42/expanded.ndjson.gz`. SHA256 `7ea095a9e256d2d8fd647e225ae99cb5feed52cca6552b1d8997e42fb45d1cc4`; 4,934,734 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope bridge-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/bridge-1-42/legacy.ndjson.gz`. SHA256 `b68019a21794b1977f843b152d9ba16458921a31bb0854bf19cdedc7c0ae7123`; 4,007,967 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope bridge-1-42 --mode legacy --stage prescreen --limit 20
```
