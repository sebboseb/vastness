...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/large_open_interior-1-7/expanded.ndjson.gz`. SHA256 `ebb59779eed7a9a00a51771a265a6f37e87bc7517e7f5acc59511080739a7459`; 827,545 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope large_open_interior-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/large_open_interior-1-7/legacy.ndjson.gz`. SHA256 `82eeca0e5d3daa08ea64cc7aa22f184107660bae00c82c26d0352dba0fc710de`; 1,128,309 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope large_open_interior-1-7 --mode legacy --stage prescreen --limit 20
```
