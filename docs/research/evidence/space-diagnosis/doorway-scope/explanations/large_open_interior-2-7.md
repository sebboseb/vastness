...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/large_open_interior-2-7/expanded.ndjson.gz`. SHA256 `802c122a851499e0c0ed1d3561f4d43ec0c661dd3dce3fa187b6a3b7b01e1642`; 318,845 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope large_open_interior-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/large_open_interior-2-7/legacy.ndjson.gz`. SHA256 `858d4209f640d2fd3359e418aa78943087ad4823806d7874ce72a763dd5f1241`; 291,662 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope large_open_interior-2-7 --mode legacy --stage prescreen --limit 20
```
