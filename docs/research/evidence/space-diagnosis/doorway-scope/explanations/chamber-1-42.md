...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/chamber-1-42/expanded.ndjson.gz`. SHA256 `94302a82499163c1c558bb8f47cf416aaee80765651e256dd0925a574b05ad0f`; 73,836 contiguous events.
...
| Proposals | Returned pass: 220 eligible; 192 attempted. All trace passes: 112 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 187, "support-edge-not-found": 20, "entry-prism-blocked": 561, "source-entry-prism": 561}; passed 0 |
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope chamber-1-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/chamber-1-42/legacy.ndjson.gz`. SHA256 `933281a541059b4ad4fbc4dcb38adde09acf2ab9bbc2ca6585124adeb3812f67`; 62,663 contiguous events.
...
|---|---|
| Generated support | 1383 valid sampled nodes; 2229 floor tests |
| Proposals | Returned pass: 199 eligible; 48 attempted. All trace passes: 604 omitted by selection; 0 selected but not attempted |
| Pre-screen | {"source-projection": 48, "entry-prism-blocked": 144, "source-entry-prism": 144}; passed 0 |
| Components | Returned pass: 0 reached-entry discoveries. All passes: 0 distinct visited nodes; not exhaustive mesh decomposition |
| Routes | All passes: 0 candidate events. Returned pass: maximum connected displacement 0.0000m |
| Topology | {} |
| Final seam | {} |
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope chamber-1-42 --mode legacy --stage prescreen --limit 20
```
