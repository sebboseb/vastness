...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/courtyard-2-42/expanded.ndjson.gz`. SHA256 `4bc6ad5cca77e31bffd399ae2a710ef4670b8d899708eeefd47485d22200269b`; 119,339 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope courtyard-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/courtyard-2-42/legacy.ndjson.gz`. SHA256 `e71e9ac5b30ec9ab41bb92a91f6dc90fbeed76b6d9ba87d21779b1dcb47cb19f`; 695,453 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope courtyard-2-42 --mode legacy --stage prescreen --limit 20
```
