...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/corridor-2-42/expanded.ndjson.gz`. SHA256 `ccc6325f75378d78d8d9b69ab3c5304f9ffb544d496414ed394952fbb8dc517c`; 68,669 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope corridor-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/corridor-2-42/legacy.ndjson.gz`. SHA256 `e04f9deefc7ab619574b740eb1c4e38f10a67888d592d2eeba3710f030ab3a30`; 49,431 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope corridor-2-42 --mode legacy --stage prescreen --limit 20
```
