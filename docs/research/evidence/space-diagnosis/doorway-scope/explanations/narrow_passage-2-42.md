...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/narrow_passage-2-42/expanded.ndjson.gz`. SHA256 `fa12310eade3332850f69b37371c3f93bdfdd522752ebafe2ca8a35ebb4e8598`; 53,877 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope narrow_passage-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/narrow_passage-2-42/legacy.ndjson.gz`. SHA256 `6048d96cf3bb0573f13fffe688fcf427b94496b179d1191d09d9cfc1495853ad`; 48,288 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope narrow_passage-2-42 --mode legacy --stage prescreen --limit 20
```
