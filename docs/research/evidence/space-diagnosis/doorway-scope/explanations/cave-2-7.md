...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/cave-2-7/expanded.ndjson.gz`. SHA256 `3597e1d189598590ea59c2741e40cde8faf72675b7b3e3fdd0b3712cd1a5e45a`; 81,339 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope cave-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/cave-2-7/legacy.ndjson.gz`. SHA256 `e3aa9b0e38d7f51a3200686f712089a96870bc6028c9faacd760376db0bfab46`; 79,460 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope cave-2-7 --mode legacy --stage prescreen --limit 20
```
