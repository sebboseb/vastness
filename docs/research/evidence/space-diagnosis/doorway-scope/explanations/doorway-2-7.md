...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/doorway-2-7/expanded.ndjson.gz`. SHA256 `9ceed4da7210945b31dcb89003aa7871db7c4a04b22f4eba97863ecf209bee4b`; 715,744 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope doorway-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/doorway-2-7/legacy.ndjson.gz`. SHA256 `fa3a7164fac28e8115e5cbb87ebd2d67fd1f9bb0bc98c0874e5b0062d997924c`; 599,529 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope doorway-2-7 --mode legacy --stage prescreen --limit 20
```
