...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/narrow_passage-1-7/expanded.ndjson.gz`. SHA256 `6beed99b8e07381d922f1cb03ddc4c4db28f840daf5a8084ce471029db3c80c1`; 9,230 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope narrow_passage-1-7 --mode expanded --stage prescreen --limit 20
```
