...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/tunnel-2-42/expanded.ndjson.gz`. SHA256 `4bbe41049169910ab2c69956d96af2e35c6d25c18204956c2173e69e003e2b33`; 1,907,673 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope tunnel-2-42 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/tunnel-2-42/legacy.ndjson.gz`. SHA256 `e735d218897ae1229ab24c4c7a74ca6f8285b2f96731d94e9c52b709df0ef316`; 1,975,672 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope tunnel-2-42 --mode legacy --stage prescreen --limit 20
```
