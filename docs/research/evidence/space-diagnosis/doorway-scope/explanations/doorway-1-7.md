...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/doorway-1-7/expanded.ndjson.gz`. SHA256 `0a1dbb648a03a2fd22fe53e73c5962e704337fe2320b61eef5d2bf251febe05a`; 695,174 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope doorway-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/doorway-1-7/legacy.ndjson.gz`. SHA256 `5b2a7119f9e70d6b351817c338a7a144bfed67e9b4e5ecafd4291b066a9101fe`; 698,440 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope doorway-1-7 --mode legacy --stage prescreen --limit 20
```
