...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/corridor-1-7/expanded.ndjson.gz`. SHA256 `82c9a73203113958b22ad68c32071af4071c4d13afdb16624b7f4073dcd7f1f9`; 137,547 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope corridor-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/corridor-1-7/legacy.ndjson.gz`. SHA256 `1632095683be9440e165fee09db76ab9a794614a8119412227f178fe91b5a0da`; 468,288 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope corridor-1-7 --mode legacy --stage prescreen --limit 20
```
