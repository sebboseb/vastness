...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/bridge-1-7/expanded.ndjson.gz`. SHA256 `a4c2a98f245f1ae80fbe74a672d8b52171c6618ec4d855a94e5934377f7db70b`; 4,394,234 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope bridge-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/bridge-1-7/legacy.ndjson.gz`. SHA256 `4d3cfe046746bf16bb4eb1799916aa9b6e08849062f994ded243092a5c3c75e4`; 4,956,791 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope bridge-1-7 --mode legacy --stage prescreen --limit 20
```
