...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/bridge-2-7/expanded.ndjson.gz`. SHA256 `837523bbb46692f803c22177cd4ab1b5b55a300b8fb11da9ddc57a03e2cdde46`; 1,977,179 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope bridge-2-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/bridge-2-7/legacy.ndjson.gz`. SHA256 `188023b86dd589ae6f10261691367beccb35c6d1b9513e765f49d36c6ab9b399`; 100,658 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope bridge-2-7 --mode legacy --stage prescreen --limit 20
```
