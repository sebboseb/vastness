...
Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/courtyard-1-7/expanded.ndjson.gz`. SHA256 `85cb60e92b996a09bf405d7d20ba55ba7dfdcf6d3c5b7dd82c7674f12aee08a6`; 335,503 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope courtyard-1-7 --mode expanded --stage prescreen --limit 20
```

## legacy: failed

Complete trace: `.runtime/space-diagnosis/doorway-scope/candidates/courtyard-1-7/legacy.ndjson.gz`. SHA256 `04d496cbfdd90e6fa9d31ad04a8d1f8c855e5f3634d0674b0c6b5995cfa3ef80`; 996,943 contiguous events.
...
```sh
python3 scripts/diagnosis/trace-query.py doorway-scope courtyard-1-7 --mode legacy --stage prescreen --limit 20
```
